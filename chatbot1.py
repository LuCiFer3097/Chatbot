...
def run_foo2():
    ...
    return "import sys; sys.path.append('path_to_your_program_folder'); from human import chat; chat()"
...
def run_foo1():
    ...
    return "import sys; sys.path.append('path_to_your_program_folder'); from chatbot import bot; bot()"
...
if __name__ == '__main__':
    ...
    # bot()
	print("Please enter your name to continue or simple press enter to exit")
	name=input()
	while name!='':
    ...
    # wait for the windows to be closed
		for proc in (processes):
			proc.wait()
		print("Bot: Hey!! Welcome back. Hope your doubts are cleared. Press enter if you want to exit or else press 2 if you still have some queries.")
		name=input('W: ')
	print("Bye!!")